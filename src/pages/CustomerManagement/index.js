  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        selector: (row) => (row.start ? row.start.split(" ")[0] : ""),
        sortable: true,
        hide: "md",
      },
      {
      ...
      },
      {
        name: locale.User,
        cell: (row) => {
          return <span className="badge">{row.users.length + 1}</span>;
        },
        selector: (row) => row.users.length + 1,
        sortable: true,
        hide: "md",
        width: "100px",
      },
              ...
              <Tippy content={"Reset Password"}>
                <li>
                  <a
                    ...
                    className="action-btn active-user"
                  >
                    {btnID === row.customer_id && btnPending ? (
